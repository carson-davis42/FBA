...
public class Main {
    ...
    private static final int TOTAL_NUM_OF_GAMES = 1120;
    private static final int NUM_OF_GAMES_PER_TEAM = 80;
    private static final int NUM_OF_CONF_PER_TEAM = 52;
...
//        randomizeWL(TOTAL_NUM_OF_GAMES); //debugger that simulates to specified game
    ...
    public static void readRosters(Scanner input) {
        ...
        for (int a = 0; a < NUM_OF_TEAMS; a++) {
            ...
            for (int b = 0; b < numOfPlayers; b++) {
                ...
                players.add(new Player(name, rat, pos, age, conLen, cost));
            }
    ...
    private static void toFileResults(Team one, Team two, boolean homeWin) throws
            IOException {
        StringBuilder sb = new StringBuilder();
        ...
        if (homeWin) {
            sb.append(gamesPlayed).append(",").append(one.getName()).append(",").append("1")
                    .append(",").append(two.getName()).append(",").append("0");
        }
        else {
            sb.append(gamesPlayed).append(",").append(one.getName()).append(",").append("0")
                    .append(",").append(two.getName()).append(",").append("1");
        }
        File file = new File("Results.txt");
        FileWriter fw = new FileWriter(file);
        fw.write(sb.toString());
    ...
    public static void makeGoodLookinStandings() throws IOException {
        ...
        File file = new File("Standings-Eastern.txt");
        FileWriter fw = new FileWriter(file);
        fw.write(sb.toString());
        fw.close();
        //Western Conference
        ...
        file = new File("Standings-Western.txt");
        ...
        file = new File("Standings-Lottery.txt");
        fw = new FileWriter(file);
        fw.write(sb.toString());
        fw.close();
        //Master Standings
