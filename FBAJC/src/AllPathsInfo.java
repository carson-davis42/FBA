 ...
 * the number of paths (which equals the number of other vertices
 * the vertex is connected to) and the total cost of all the paths.
 */
...
public class AllPathsInfo implements Comparable<AllPathsInfo> {
    ...
    public String toString() {
        return "Name: "
                + String.format("%1$-" + PADDING + "s", vertexName)
                + " cost per path: " + ourFormatter.format(aveCost)
                + ", num paths: " + numPaths;
    }
